...
- `howl-pm` means the product-facing shell/package command.
- `howl-pm-admin` means the backend/admin tool.
- `howl-pm` means the repo/module/project identity.
...
- `app_architecture/HOWL_PM_CLI.md` — user-facing mobile package CLI
...
- `app_architecture/HOWL_PM_ARTIFACT_CONSUMER.md` — MP-A7 Howl runtime consumer contract
