...
| File | Purpose |
|------|---------|
| `dist/product-candidate/howl-android-prefix.tar.gz` | Prefix archive (`usr/` root) |
...
Consumer rules for emitted manifests: `app_architecture/HOWL_PM_ARTIFACT_CONSUMER.md`.
