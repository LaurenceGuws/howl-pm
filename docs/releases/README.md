...
Release notes and published artifact records live here once `howl-pm-admin`
...
```bash
go run ./cmd/howl-pm-admin android-dev-snapshot-release
```
...
The prefix archive includes the Android `howl-pm` binary and a package install
